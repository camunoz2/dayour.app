  ...
  return (
    <>
      ...
      <Layout>
        <DateComponent />
        <Separator />
        <div className="relative flex flex-col md:flex-row justify-between pt-6">
          <RiveComponent className="w-64 h-64 hidden md:block md:fixed bottom-0 right-10 -z-10" />
